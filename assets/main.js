...
const navItems = [
  ["company", "COMPANY", "회사소개", "company.html"],
  ["services", "SERVICES", "사업분야", "services.html"],
  ["capabilities", "CAPABILITIES", "설계역량", "capabilities.html"],
  ["projects", "PROJECTS", "프로젝트", "projects.html"],
  ["contact", "CONTACT", "문의", "contact.html"]
];
  ...
  header.innerHTML = `
    ...
    <header class="site-header">
      <div class="container header-inner">
        ...
        <a class="header-cta" href="contact.html">설계 프로젝트 문의</a>
